...
Para ver el detalle de los hitos y el progreso técnico, consulta nuestro [Roadmap Detallado](./docs/ROADMAP.md).

- **M1: Core & Multi-tenancy** 🚧 (En desarrollo)
- **M2: OMS & DDD Logic** ⏳
- **M3: HTMX & Celery Async** ⏳
